                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                                {isMounted ? formatDate(guest.createdAt) : guest.createdAt}
                              </p>
                            </div>
                          </div>
                        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    ...
                    <p className="text-base font-semibold text-gray-900 dark:text-gray-100">
                      {selectedGuest.dateOfBirth ? (isMounted ? formatDate(selectedGuest.dateOfBirth) : selectedGuest.dateOfBirth) : 'Non renseigné'}
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 rounded-lg">
                    ...
                    <p className="text-base font-bold text-green-900 dark:text-green-100">
                      {isMounted ? formatDate(selectedGuest.createdAt) : selectedGuest.createdAt}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    ...
                    <p className="text-base font-semibold text-gray-900 dark:text-gray-100">
                      {isMounted ? formatDate(selectedGuest.updatedAt) : selectedGuest.updatedAt}
                    </p>
                  </div>
                </div>
              </div>
